...
read-only system templates and browser-local user templates in one list, while
keeping structured row entry, preview, and print on the same route.
...
as, and version history semantics.
