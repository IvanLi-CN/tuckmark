...
export interface ServerService {
  ...
  probePrinter(printerId: string, printerName?: string): Promise<Awaited<ReturnType<TuckmarkService["probePrinter"]>>>;
  ...
  previewTemplate(request: PreviewRequest): Promise<Awaited<ReturnType<TuckmarkService["previewTemplate"]>>>;
  previewCanvas(
  ...
  printBatch(request: PrintBatchRequest): Promise<Awaited<ReturnType<TuckmarkService["printBatch"]>>>;
  printByTemplate(
    request: PrintByTemplateRequest
  ): Promise<Awaited<ReturnType<TuckmarkService["printByTemplate"]>>>;
  printCanvas(request: PrintCanvasRequest): Promise<Awaited<ReturnType<TuckmarkService["printCanvas"]>>>;
  printSafeTextLabel(
    printerId: string,
    request: SafeTextLabelInput,
    printerName?: string
...
export function startServer(service: ServerService = new TuckmarkService(), port = Number(process.env.PORT ?? 5210)) {
