const shippingLabel = {
    ...
    elements: [
        { kind: "rect", x: 8, y: 8, width: 368, height: 208, strokeWidth: 2, fill: "white", stroke: "#111111", radius: 8 },
        { kind: "text", key: "__title", value: "SHIP TO", x: 18, y: 28, fontSize: 18, fontWeight: "bold", align: "left" },
        { kind: "text", key: "recipient", x: 18, y: 62, fontSize: 26, fontWeight: "bold", align: "left" },
        { kind: "text", key: "address", x: 18, y: 96, fontSize: 18, fontWeight: "normal", align: "left", maxLines: 3 },
        { kind: "line", x1: 18, y1: 166, x2: 366, y2: 166, strokeWidth: 2, stroke: "#111111" },
        { kind: "text", key: "__order_label", value: "ORDER", x: 18, y: 192, fontSize: 14, fontWeight: "bold", align: "left" },
        { kind: "text", key: "orderId", x: 90, y: 192, fontSize: 14, fontWeight: "normal", align: "left" },
        { kind: "text", key: "note", x: 220, y: 192, fontSize: 14, fontWeight: "normal", align: "right", width: 140 }
    ]
};
const cableLabel = {
    id: "cable-tag",
    ...
    elements: [
        { kind: "rect", x: 6, y: 6, width: 372, height: 148, strokeWidth: 2, fill: "white", stroke: "#111111", radius: 12 },
        ...
        { kind: "text", key: "location", x: 200, y: 104, width: 160, fontSize: 20, fontWeight: "normal", align: "right" }
    ]
};
export const presetTemplates = [shippingLabel, cableLabel];
