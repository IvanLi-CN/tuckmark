...
export const shippingLabelTemplate: TemplateDefinition = {
  id: "shipping-compact",
...
export const cableLabelTemplate: TemplateDefinition = {
  id: "cable-tag",
  name: "Cable Tag",
...
export const presetTemplateData: TemplateDefinition[] = [shippingLabelTemplate, cableLabelTemplate]
